...
export default class Contact extends React.Component{
    render(){
        return(
            <div className="bg-gray-700 bg">    
                <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
                    <h2 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                        <span className="block font-lg">Get A Quote</span>
                        <span className="block text-gray-400 text-base subpixel-antialiased tracking-wide font-medium">Fill up te form and our team will get back to you within 24 hour.</span>
                        <br/>
                        <hr className=' w-6/12'/>
                    </h2>
                    <div className="mr-32">
                    <form >
                        ...
                        <button type="submit" class="text-gray-700 bg-gray-100 hover:bg-gray-100 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-gray-100 dark:hover:bg-gray-100 dark:focus:ring-blue-800">Submit</button>
                    </form>
                </div>
                </div>
            </div>
